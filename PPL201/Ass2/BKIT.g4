...
expr: expr1 (GREATER_INT| GREATER_EQ_INT|LESS_INT|LESS_EQ_INT|EQ_INT|N_EQ_INT|GREATER_FLOAT|GREATER_EQ_FLOAT|LESS_FLOAT|LESS_EQ_FLOAT|EQ_FLOAT) expr1 | expr1;
...
operand: func_call | IDENTIFIER | INTLIT | FLOATLIT | STRINGLIT | BOOLLIT | array ;
...
func_declare: FUNCTION ':' IDENTIFIER
...
ass_stmt: (IDENTIFIER | (expr7 ('['expr']')+)) '=' expr ';';
...
//else if statemet
else_if_stmt: ELSEIF expr THEN var_declare*? stmt_list;

else_stmt: ELSE var_declare*? stmt+;
